...
- §<N>.<M> — uses `~/Documents/Projects/mingtai/traffic-light/<path>` to illustrate _<concept>_.

## Further reading
_Top 3–5 entries from [[reading_list]] that the reader should sample first._
